...
require (
	...
	github.com/kubewharf/katalyst-api v0.5.7-0.20250904111935-47f5110ad28b
...
replace (
	github.com/kubewharf/katalyst-api => github.com/xudongliuharold/katalyst-api v0.0.0-20250909040534-a9adc14754d7
